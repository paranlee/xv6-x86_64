...
struct segdesc {
    ...
    uint db : 1;            // 0 = 16-bit segment, 1 = 32-bit segment <- this must be clear in IA-32e mode
...
struct tssdesc {
    ...
    uint32_t db : 1;            // 0 = 16-bit segment, 1 = 32-bit segment <- this must be clear in IA-32e mode
